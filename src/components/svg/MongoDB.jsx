...
const MongoDB = ({ size, color, handleChangeLanguage, language }) => {
  return (
    <div className="skillSVG" id={language} onClick={handleChangeLanguage}>
      <svg
      ...
      >
        <path
          ...
          fill={color.length === 3 ? color[0] : color}
        />
        <path
          ...
          fill={color.length === 3 ? color[1] : color}
        />
        <path
          ...
          fill={color.length === 3 ? color[2] : color}
        />
      </svg>
    </div>
  );
